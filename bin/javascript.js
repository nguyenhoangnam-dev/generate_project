let jsIndex = `$(document).ready(function() {
  ...
  $("body").scroll(function(e) {
    if ($(window).scrollTop() == Math.floor($("#section5").offset().top)) {
